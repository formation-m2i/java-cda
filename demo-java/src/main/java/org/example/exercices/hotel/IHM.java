...
public class IHM {
    ...
    public static void initialisationHotel() {
        ...
        new Client(6, "Bernard", "Norris", "0722383392").addReservation(new Reservation(4, StatutReservation.VALIDATED, new Client("Bernard", "Norris", "0722383392"), new Chambre(1, StatutChambre.TAKEN, 31.61, 1)));
